...
## **Data Preparation**
![小吴你需要学习的还有很多，download一个数据集就够你喝两壶了hh](../OVD_files/TOOL_img/large_scale.png)
...
![不是孩子什么时候那么富裕过？](../OVD_files/TOOL_img/download.png)
#### 命令选项解析
...
![大半夜下载存在百度网盘的数据集还是被硬控了hh](../OVD_files/TOOL_img/bypy.png)
...
3. **`修改了CLIP模型的缓存路径到付费空间`**
   ![修改了CLIP模型的缓存路径到付费空间](../OVD_files/TOOL_img/CLIP_cache_path.png)
